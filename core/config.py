"""
core/config.py
Zentrale Konfigurationsklasse für den Exocortex (v1.4.0).
Liest Umgebungsvariablen / .env und stellt typisierte Einstellungen bereit.
"""
...
# Versuche python-dotenv zu laden, falls installiert; ansonsten reines os.environ
try:
    from dotenv import load_dotenv
    # Sucht nach .env im Projekt-Root
