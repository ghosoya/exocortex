...
> *"1. Thermodynamics of Economic Activity: In non-equilibrium thermodynamics, any macroscopic system that processes information must generate entropy (ΔS > 0)... To create an organized state, entropy must be exported to the surroundings...* <br>
